...
if total_num>5:
        print(f'편의점의 총 매출은 {total_sales-(total_sales*0.15)}원입니다.')
else :
        print(f'편의점의 총 매출은 {total_sales}원입니다.')
...
if total_num>5:
        print(f'편의점의 총 매출은 {all_sales - (all_sales*0.15)}원입니다.')
else:
        print(f'편의점의 총 매출은 {all_sales}원입니다.')
